...
const PreNavbar = () => {
    return (
        <div className='preNav'>
            ...
            <div>
                <a href="https://www.mi.com/in/service/authorized_stores/">Sign In</a><span>|</span>
                <a href="https://www.mi.com/in/service/authorized_stores/">Sign UP</a><span>|</span>
                <a className='cart-anchor' href="https://store.mi.com/in/cart">{cartIcon}  CART(0)</a><span>|</span>
            </div>
